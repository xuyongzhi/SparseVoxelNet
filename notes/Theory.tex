...
Let intersection point to be in both blocks.\par
$$ sj \leq P_i \leq sj+w $$
$$ \frac{P_i-w}{s} \leq j \leq \frac{P_i}{s} $$
...
$$ U_0=s_0j_0+w_0 \leq  s_1j_1+w_1 $$
$$ \frac{U_0-w_1}{s_1}  \leq j_1 \leq \frac{L_0}{s_1}$$
