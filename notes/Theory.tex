...
$$ j:range(j_L, j_U+1) $$
Note: Simplify programming of $j_L$:
$$j_L=ceil(L+1^{-5})$$
...
$$ s_1j_1 \leq s_0j_0 = L_0$$
$$ U_0=s_0j_0+w_0 < s_1j_1+w_1 $$
$$ \frac{U_0-w_1}{s_1} = \frac{s_0j_0+w_0-w_1}{s_1} < j_1 \leq \frac{s_0j_0}{s_1} = \frac{L_0}{s_1}$$
$$j_{1L}=ceil(\frac{s_0j_0+w_0-w_1}{s_1} +1^{-5}) = ceil(\frac{U_0-w_1}{s_1}+1^{-5})$$
$$j_{1U} = floor(\frac{s_0j_0}{s_1}) = floor(\frac{L_0}{s_1})$$
